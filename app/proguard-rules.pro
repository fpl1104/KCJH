...
# in /Users/keith_fan/Library/Android/sdk/tools/proguard/proguard-android.txt
...
#---------------------------------实体类---------------------------------
#修改成你对应的包名
-keep class com.mr.utils.** { *; }

#---------------------------------第三方包-------------------------------
#-libraryjars libs/library_mr_utils.jar
#支付宝支付
...
#-libraryjars libs/armeabi-v7a/libhyphenate_av_recorder.so
#-libraryjars libs/armeabi-v7a/libsqlite.so

##-----volley------
-dontwarn com.mr.http.**
-keep class com.mr.http.**{*;}

-keep class com.mr.model.**{
        <fields>;
        <methods>;
}
