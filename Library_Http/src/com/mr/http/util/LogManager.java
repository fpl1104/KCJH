...
import com.mr.http.log.MR_BaseLog;
import com.mr.http.log.MR_FileLog;
import com.mr.http.log.MR_JsonLog;
import com.mr.http.log.MR_XmlLog;
...
public class LogManager {
	...
	private static void printLog(int type, String tagStr, Object... objects) {
		...
		case E:
		case A:
			MR_BaseLog.printDefault(type, tag, headString + msg);
			break;
		case JSON:
			MR_JsonLog.printJson(tag, msg, headString);
			break;
		case XML:
			MR_XmlLog.printXml(tag, msg, headString);
			break;
		}
	}
	...
	private static void printFile(String tagStr, File targetDirectory, String fileName, Object objectMsg) {
		...
		MR_FileLog.printFile(tag, targetDirectory, fileName, headString, msg);
	}
