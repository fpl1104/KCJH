...
public class MR_AuthFailureError extends MR_VolleyError {
    ...
    public MR_AuthFailureError(MR_NetworkResponse response) {
        super(response);
    }

    public MR_AuthFailureError(String message) {
        super(message);
    }

    public MR_AuthFailureError(String message, Exception reason) {
