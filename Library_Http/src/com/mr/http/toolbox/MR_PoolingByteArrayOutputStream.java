 ...
 */
public class MR_PoolingByteArrayOutputStream extends ByteArrayOutputStream {
    /**
     * If the {@link #PoolingByteArrayOutputStream(MR_ByteArrayPool)} constructor is called, this is
     * the default size to which the underlying byte array is initialized.
     */
    private static final int DEFAULT_SIZE = 256;

    private final MR_ByteArrayPool mPool;
     ...
     */
    public MR_PoolingByteArrayOutputStream(MR_ByteArrayPool pool) {
     ...
     *        minimum size.
     */
    public MR_PoolingByteArrayOutputStream(MR_ByteArrayPool pool, int size) {
        mPool = pool;
