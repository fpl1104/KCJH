 ...
 */
public class MR_AndroidAuthenticator implements MR_Authenticator {
     ...
     */
    public MR_AndroidAuthenticator(Context context, Account account, String authTokenType) {
    ...
    @Override
    public String getAuthToken() throws MR_AuthFailureError {
        ...
        try {
            ...
            throw new MR_AuthFailureError("Error while retrieving auth token", e);
        }
        String authToken = null;
        if (future.isDone() && !future.isCancelled()) {
            if (result.containsKey(AccountManager.KEY_INTENT)) {
                Intent intent = result.getParcelable(AccountManager.KEY_INTENT);
                throw new MR_AuthFailureError(intent);
            }
            authToken = result.getString(AccountManager.KEY_AUTHTOKEN);
        }
        if (authToken == null) {
            throw new MR_AuthFailureError("Got null auth token for type: " + mAuthTokenType);
        }
